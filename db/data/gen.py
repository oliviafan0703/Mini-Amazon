...
def gen_products(num_products):
    ...
    with open('Products.csv', 'w') as f:
        ...
        for product_id in range(num_products):
            ...
            writer.writerow([product_id, image_url, product_name, category_name])
...
def gen_inventorys(num_inventorys):
    with open('Inventorys.csv', 'w') as f:
        ...
        for id in range(num_inventorys):
            ...
            writer.writerow([product_id, quantity, seller_id, product_description, price])
...
def gen_reviews_product(num_reviews):
    with open('ProductReviews.csv', 'w') as f:
        ...
        for id in range(num_reviews):
            ...
            writer.writerow([user_id, product_id, rating, title, content, time_post])
        print(f'{num_reviews} generated')
    return

def gen_reviews_seller(num_reviews):
    with open('SellerReviews.csv', 'w') as f:
        ...
        for id in range(num_reviews):
            ...
            rating = fake.random_int(min=0, max=5)
            time_post= fake.date_time()
            writer.writerow([user_id, seller_id, rating, title, content, time_post])
        print(f'{num_reviews} generated')
    return
    ...
    with open('Order_Details.csv', 'w') as f:
        ...
        for order_id in range(num_orders):
            for i in range(10):
                ...
                seller_id = random.choice(generated_seller_ids)
                writer.writerow([order_id, quantity, fulfill_status, order_timestamp, fulfill_timestamp, product_id, seller_id])
...
gen_orders(num_orders)
gen_reviews_seller(num_reviews)
gen_reviews_product(num_reviews)
